  ...
  function build() {
    return [
      S.concept({
        ...
        body:
          "<p>A diferença entre <b>iluminação direta</b> e <b>global</b> está em <i>quais</i> " +
          "caminhos da luz o modelo leva em conta antes de a luz chegar ao olho.</p>" +
          "<p>Direta: só o que vem <b>direto da fonte</b>. Global: também a luz que " +
          "<b>rebate</b> entre as superfícies.</p>",
        visual: svgStep("all"),
      }),
      {
